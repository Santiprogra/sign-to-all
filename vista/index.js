...
window.onload = function () {
  base_preguntas = readText("vista/base-preguntas.json");
  ...
  while (npreguntas.includes(n)) {
    ...
    if (npreguntas.length == interprete_bp.length) {
      ...
      if (mostrar_pantalla_juego_términado) {
        ...
        var inputResultado = document.getElementById("resultadoInput");
        inputResultado.value = preguntas_correctas;
      }
...
var p_correctas = preguntas_correctas;

document.getElementById("p_correctas").textContent = dataFromJS;
